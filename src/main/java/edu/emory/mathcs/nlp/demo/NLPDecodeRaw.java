 ...
 */
public class NLPDecodeRaw
{
	static public void main(String[] args) throws Exception
	{
		final String configurationFile = "edu/emory/mathcs/nlp/configuration/config-decode-en-pos.xml";
		final String inputFile  = "inputfile.txt";
		final String outputFile = "outputfile.tsv";
